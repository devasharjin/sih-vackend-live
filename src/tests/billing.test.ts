import { BillingService, FIXED_TRANSPORT_FEE } from "../services/billing.service";
...
const samplePricing = {
  ...
  transportFee: FIXED_TRANSPORT_FEE, // 30
};
...
const res30 = BillingService.calculateBillingAndDistribution(30, samplePricing);
...
// Customer Total = 300 + 30 = 330
const res60 = BillingService.calculateBillingAndDistribution(60, samplePricing);
...
const res61 = BillingService.calculateBillingAndDistribution(61, samplePricing);
...
// Customer Total = 450 + 30 = 480
const res120 = BillingService.calculateBillingAndDistribution(120, samplePricing);
...
const res121 = BillingService.calculateBillingAndDistribution(121, samplePricing);
...
assertThrows(
  () => BillingService.calculateWorkingDurationMinutes(start, earlier),
  "Negative duration (completed < started) throws error"
);

const durationCalc = BillingService.calculateWorkingDurationMinutes(start, later);
assertEqual(durationCalc, 75, "75m between 10:00 and 11:15");

// Test Case 7: Validation of share percentages (>100%)
assertThrows(
  () =>
    BillingService.calculateBillingAndDistribution(60, {
      ...samplePricing,
...
assertEqual(
  res61.workerNetEarnings + res61.cooperativeAdminShare + res61.insuranceShare,
  res61.serviceAmount,
  "Deductions sum exactly to gross service earnings without touching transport fee"
);
