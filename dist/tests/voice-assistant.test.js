...
async function runVoiceAssistantTests() {
    ...
    assert_1.default.strictEqual(res1.serviceName, "Electrical Wiring");
    assert_1.default.strictEqual(res1.serviceId, "6501a1111111111111111111");
    assert_1.default.strictEqual(res1.bookingDate, tomorrowStr);
    assert_1.default.strictEqual(res1.bookingTime, "10:00");
    assert_1.default.ok(res1.customerAddress?.includes("Avadi"));
    assert_1.default.strictEqual(res1.isReadyToBook, true);
    ...
    assert_1.default.strictEqual(res2.detectedLanguage, "ta");
    assert_1.default.ok(res2.serviceName === "Tap Repair" || res2.serviceName === "Pipe Leakage & Drainage Emergency");
    assert_1.default.strictEqual(res2.bookingDate, tomorrowStr);
    assert_1.default.strictEqual(res2.bookingTime, "10:00");
    assert_1.default.ok(res2.missingFields.includes("address"));
    assert_1.default.ok(res2.responseMessage.includes("முகவரி") || res2.responseMessage.includes("நேரம்"));
    ...
    assert_1.default.strictEqual(res3.detectedLanguage, "hi");
    assert_1.default.ok(res3.serviceName?.includes("Tap") || res3.serviceName?.includes("Pipe"));
    assert_1.default.strictEqual(res3.bookingDate, tomorrowStr);
    assert_1.default.strictEqual(res3.bookingTime, "10:00");
    ...
    assert_1.default.strictEqual(res4.detectedLanguage, "te");
    assert_1.default.ok(res4.serviceName?.includes("Tap") || res4.serviceName?.includes("Pipe"));
    assert_1.default.strictEqual(res4.bookingDate, tomorrowStr);
    assert_1.default.strictEqual(res4.bookingTime, "10:00");
    ...
    assert_1.default.strictEqual(res5.serviceName, "Furniture Assembly & Woodwork");
    assert_1.default.strictEqual(res5.bookingTime, null);
    assert_1.default.ok(res5.missingFields.includes("time"));
    assert_1.default.ok(res5.responseMessage.toLowerCase().includes("time"));
    ...
    assert_1.default.strictEqual(res6.bookingTime, "16:00");
    assert_1.default.strictEqual(res6.customerAddress, null);
    assert_1.default.ok(res6.missingFields.includes("address"));
    assert_1.default.ok(res6.responseMessage.toLowerCase().includes("address"));
    ...
    assert_1.default.ok(res7.candidateServices && res7.candidateServices.length > 1);
    ...
    assert_1.default.strictEqual(res8.serviceId, null);
    assert_1.default.ok(res8.responseMessage.toLowerCase().includes("not find") || res8.responseMessage.toLowerCase().includes("catalog"));
    ...
    assert_1.default.strictEqual(res9.bookingDate, todayStr);
    ...
    assert_1.default.strictEqual(turn2.serviceName, "Electrical Wiring"); // Preserved from turn 1
    assert_1.default.strictEqual(turn2.bookingDate, tomorrowStr); // Preserved from turn 1
    assert_1.default.strictEqual(turn2.bookingTime, "16:00"); // Added in turn 2
    ...
    assert_1.default.strictEqual(turn3.serviceName, "Electrical Wiring");
    assert_1.default.strictEqual(turn3.bookingTime, "16:00");
    assert_1.default.ok(turn3.customerAddress?.includes("Avadi"));
    assert_1.default.strictEqual(turn3.isReadyToBook, true);
    ...
    assert_1.default.strictEqual(turnCorrection.bookingTime, "18:00");
    assert_1.default.ok(turnCorrection.customerAddress?.includes("Anna Nagar"));
    ...
    assert_1.default.strictEqual(resEmergency.bookingType, "EMERGENCY");
    assert_1.default.strictEqual(resEmergency.serviceName, "Pipe Leakage & Drainage Emergency");
    ...
    assert_1.default.ok(res1.matchedService);
    assert_1.default.strictEqual(res1.matchedService.firstHourRate, 280);
    assert_1.default.strictEqual(res1.matchedService.transportFee, 30);
    ...
    assert_1.default.strictEqual(resProfile.customerAddress, "Flat 402, Lotus Residency, Chennai 600028");
    ...
    assert_1.default.ok(resFallback.serviceName?.includes("Tap"));
    assert_1.default.strictEqual(resFallback.bookingTime, "11:00");
    assert_1.default.strictEqual(resFallback.isReadyToBook, true);
...
//# sourceMappingURL=voice-assistant.test.js.map